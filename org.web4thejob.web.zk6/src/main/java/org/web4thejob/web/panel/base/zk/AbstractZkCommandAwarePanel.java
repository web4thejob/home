...
import org.web4thejob.web.panel.base.AbstractCommandAwarePanel;
...
public abstract class AbstractZkCommandAwarePanel extends AbstractCommandAwarePanel {
    ...
    protected void processValidCommand(Command command) {
        if (CommandEnum.CONFIGURE_SETTINGS == command.getId()) {
            Dialog dialog = ContextUtil.getDialog(DefaultSettingsDialog.class, this);
